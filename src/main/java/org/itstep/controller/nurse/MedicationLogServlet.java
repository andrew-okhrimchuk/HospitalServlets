...
@WebServlet("/nurse/medicationLog")
public class MedicationLogServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        log.info("Start MedicationLogServlet doGet ");
        ...
        try {
            ...
            log.info("Find my MedicationLogServlet count = " + lists);
        ...
        engine.process("nurse/medicationLog.html", context, response.getWriter());
    }
}