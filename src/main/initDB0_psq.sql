...
INSERT INTO PATIENT (id, iscurrentpatient, birthdate)
VALUES (1, true,  TO_DATE('17/11/2018', 'DD/MM/YYYY')),
       (2, true,  TO_DATE('17/11/2018', 'DD/MM/YYYY')),
       (3, true,  TO_DATE('17/11/2018', 'DD/MM/YYYY')),
       (4, true,  TO_DATE('17/11/2018', 'DD/MM/YYYY')),
       (5, true,  TO_DATE('17/11/2018', 'DD/MM/YYYY')),
       (6, true,  TO_DATE('17/11/2018', 'DD/MM/YYYY'));
